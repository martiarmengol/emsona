...
before = load_embeddings("../../essentia-models/effnet/embeddings/before_2012-2025-05-13-effnet-multi.pkl", "Before 2012")
after = load_embeddings("../../essentia-models/effnet/embeddings/after_2018-2025-05-13-effnet-multi.pkl", "After 2018")
...
plt.title("t-SNE of Effnet Multi Audio Embeddings (Colored by Population)")
plt.xlabel("t-SNE Dimension 1")
plt.ylabel("t-SNE Dimension 2")
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()

output_dir = "visualization_results/embedding_visualization_effnet_multi_by_feature"
...
def create_interactive_plot(color_by, title_suffix=None, show_legend=True, custom_labels=None):
    ...
    fig = px.scatter(
        ...
        title=f"Interactive t-SNE of Effnet Multi Audio Embeddings (Colored by {title_suffix})",
        labels={
            "x": "t-SNE Dimension 1", 
            "y": "t-SNE Dimension 2", 
